...
public static class SaveSystem
{
    ...
    public static void SaveCollection(int[] character)
    {
        BinaryFormatter formatter = new BinaryFormatter();
    ...
    // public static void SaveLoadout(int[] item)
    // {
    //     BinaryFormatter formatter = new BinaryFormatter();
    //     string path = Application.persistentDataPath + "/loadout.fun";

    //     using (FileStream stream = new FileStream(path, FileMode.Create))
    //     {
    //         LoadoutData data = new LoadoutData(item);
    //         formatter.Serialize(stream, data);
    //     }

    //     Debug.Log("loadout saved at: " + path);
    // }
    ...
    //         using (FileStream stream = new FileStream(path, FileMode.Open))
    //         {
    //             LoadoutData data = formatter.Deserialize(stream) as LoadoutData;
    //             return data;
    //         }
    //     }
    //     else
